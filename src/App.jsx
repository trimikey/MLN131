...
function App() {
  ...
  useEffect(() => {
    const handleMouseDown = (e) => {
      const target = e.target.closest('.control-btn, .game-tab-btn, .tf-btn, .match-card, .quick-prompt-btn');
      if (!target) return;
  ...
  const handleTfAnswer = (ans) => {
    ...
    if (correct) {
      ...
      setTfStreak(0);
      addToast(willDeduct ? '❌ Chưa đúng! −5 điểm' : '❌ Chưa đúng!', 'error');
    }
  };
                ...
                <div className="quiz-container">
                  {quizStep === 0 ? (
                    <div style={{ textAlign: 'center', padding: '24px 10px' }}>
                      ...
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', margin: '0 auto 24px', maxWidth: '560px' }}>
                    ...
                    <div style={{ textAlign: 'center', padding: '24px 10px' }}>
                      <h3 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--accent)', marginBottom: '10px' }}>Tổng kết</h3>
                ...
                <div className="match-container">
                  ...
                  {matchedPairs.length === MATCHING_PAIRS.length ? (
                    <div style={{ textAlign: 'center', padding: '28px 0' }}>
                      ...
                      <h3 style={{ fontWeight: '800', color: 'var(--accent)', marginBottom: '16px' }}>Hoàn thành tất cả {MATCHING_PAIRS.length} cặp!</h3>
                ...
                <div className="tf-container">
                  {tfGameStatus === 'idle' && (
                    <div style={{ textAlign: 'center', padding: '28px 10px' }}>
                      ...
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.88rem', margin: '0 auto 22px', maxWidth: '480px' }}>
                  ...
                  {tfGameStatus === 'done' && (
                    <div style={{ textAlign: 'center', padding: '24px 10px' }}>
                      <h3 style={{ fontSize: '1.4rem', fontWeight: '800', color: 'var(--accent)', marginBottom: '10px' }}>Kết quả</h3>
